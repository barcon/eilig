...
LIBS += -lutils -llogger
ALL_LDFLAGS += $(LDFLAGS) -L../../utils/build/Debug -L../../logger/build/Debug -L/usr/lib64 -m64
...
LIBS += -lutils -llogger
ALL_LDFLAGS += $(LDFLAGS) -L../../utils/build/Release -L../../logger/build/Release -L/usr/lib64 -m64 -s
...
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O3
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O3 -std=c++17
LIBS += -lutils -llogger -lclub -lopencl
ALL_LDFLAGS += $(LDFLAGS) -L../../utils/build/Release -L../../logger/build/Release -L../../club/build/Release -L../../opencl/lib/x86_64 -L/usr/lib64 -m64 -s
